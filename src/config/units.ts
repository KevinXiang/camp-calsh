...
export const UNIT_DEFS: Record<UnitKind, UnitDef> = {
  ...
  medic:     { kind: 'medic',     attackType: 'ranged', maxHp: 120, attack: 0,  attackRange: 150, attackInterval: 2.0, moveSpeed: 50, healAmount: 12, healSearchRange: 300, poisonDamage: 8, poisonDuration: 2, poisonRange: 300, poisonCooldown: 3 },
