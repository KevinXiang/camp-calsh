...
describe('Artillery splash damage', () => {
  it('溅射范围内多个目标同时受伤', () => {
    const gs = makeGs();
    const target: Unit = { id: 't1', faction: 'blue', kind: 'sword', campId: 'c1', x: 100, y: 100, hp: 100, maxHp: 100, attack: 10, attackRange: 35, attackInterval: 1.0, moveSpeed: 60, attackTimer: 0, targetId: null, state: 'idle', alive: true, deathTimer: 0, poisonTimer: 0, poisonDps: 0, poisonCooldownTimer: 0 };
    const nearby: Unit = { id: 't2', faction: 'blue', kind: 'shield', campId: 'c1', x: 140, y: 100, hp: 160, maxHp: 160, attack: 7, attackRange: 35, attackInterval: 1.2, moveSpeed: 45, attackTimer: 0, targetId: null, state: 'idle', alive: true, deathTimer: 0, poisonTimer: 0, poisonDps: 0, poisonCooldownTimer: 0 };
